...
namespace PED
{
	...
	static Player GET_PED_MONEY(Ped ped) { return invoke<Player>(0x3F69145BBA87BAE7, ped); } // 0x3F69145BBA87BAE7 0xEB3C4C7E
...
namespace VEHICLE
{
	...
	static void _SET_VEHICLE_SUKA(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x1CF38D529D7441D9, vehicle, toggle); } // 0x1CF38D529D7441D9 0xDF594D8D
...
namespace OBJECT
{
	static Object CREATE_OBJECT(Object modelHash, float x, float y, float z, BOOL isNetwork, BOOL spawnCheck, BOOL dynamic) { return invoke<Object>(0x509D5878EB39E842, modelHash, x, y, z, isNetwork, spawnCheck, dynamic); } // 0x509D5878EB39E842 0x2F7AA05C
...
namespace GAMEPLAY
{
	...
	static void DELETE_INCIDENT(int test) { invoke<Void>(0x556C1AA270D5A207, test); } // 0x556C1AA270D5A207 0x212BD0DC
...
namespace ITEMSET
{
	static Any CREATE_ITEMSET(Vector3* distri) { return invoke<Any>(0x35AD299F50D91B24, distri); } // 0x35AD299F50D91B24 0x0A113B2C
...
namespace SCRIPT
{
	...
	static int GET_EVENT_AT_INDEX(BOOL p0, int eventNum) { return invoke<int>(0xD8F66A3A60C62153, p0, eventNum); } // 0xD8F66A3A60C62153 0xB49C1442
	static BOOL GET_EVENT_DATA(BOOL p0, int eventNum, int* argStruct, int argStructSize) { return invoke<BOOL>(0x2902843FCD2B2D79, p0, eventNum, argStruct, argStructSize); } // 0x2902843FCD2B2D79 0x4280F92F
	static void TRIGGER_SCRIPT_EVENT(BOOL p0, int* args, int argCount, int bit) { invoke<Void>(0x5AE99C571D5BBE5D, p0, args, argCount, bit); } // 0x5AE99C571D5BBE5D 0x54763B35
...
namespace UI
{
	...
	static int _SET_NOTIFICATION_MESSAGE(char* p0, int p1, int p2, int p3, BOOL p4, char* picName1, char* picName2) { return invoke<int>(0x2B7E9A4EAAA93C89, p0, p1, p2, p3, p4, picName1, picName2); } // 0x2B7E9A4EAAA93C89 0xED130FA1
	...
	static int _END_TEXT_COMMAND_GET_LINE_COUNT(float x, float y) { return invoke<int>(0x9040DFB09BE75706, x, y); } // 0x9040DFB09BE75706 0xAA318785
	...
	static void _SET_PED_ENEMY_AI_BLIP(int pedHandle, BOOL showViewCones) { invoke<Void>(0xD30C50DF888D58B5, pedHandle, showViewCones); } // 0xD30C50DF888D58B5 0x96C4C4DD
	static BOOL DOES_PED_HAVE_AI_BLIP(Ped ped) { return invoke<BOOL>(0x15B8ECF844EE67ED, ped); } // 0x15B8ECF844EE67ED 0x3BE1257F
	static void _0xE52B8E7F85D39A08(Ped ped, int unk) { invoke<Void>(0xE52B8E7F85D39A08, ped, unk); } // 0xE52B8E7F85D39A08 0xD8E31B1A
...
namespace GRAPHICS
{
	...
	static void _0xE83A3E3557A56640(char* button) { invoke<Void>(0xE83A3E3557A56640, button); } // 0xE83A3E3557A56640 0xCCBF0334
...
namespace NETWORK
{
	...
	static void _SET_NETWORK_VEHICLE_NON_CONTACT(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x6274C4712850841E, vehicle, toggle); } // 0x6274C4712850841E 0xEA235081
...
namespace UNK3
{
	...
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE(int* value, Any p1, Any p2, Any p3, Any p4, int p5) { return invoke<BOOL>(0x3C5FD37B5499582E, value, p1, p2, p3, p4, p5); } // 0x3C5FD37B5499582E
